      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        <Reveal delay={0.08}>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-sm leading-7 text-slate-300 backdrop-blur-xl md:p-8">
            <p>
              I build ML and GenAI systems with attention to backend structure, data quality, inference workflows,
              and explainability. My work spans NLP, retrieval-augmented generation, geospatial analytics,
              prediction pipelines, and interactive product surfaces.
            </p>
            <p className="mt-4">
              I value production constraints, deployment clarity, and practical UX for technical products. That means
              designing systems that are understandable, maintainable, and credible in interviews and demo settings.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-2 text-white">8.64</p>
              </div>
            </div>
          </div>
        </Reveal>
